...
<head>
    ...
    <title>SIMONA | Tambah Produk</title>
                        ...
                        <div class="card-body">
                            <form action="" method="post">
                                <div class="form-group">
                                    ...
                                    <input type="nama" class="form-control" id="produk_name" name="produk_name">
                                    <?= form_error('produk_name', '<small class="pl-3 text-danger">', '</small>'); ?>
                                </div>
                                <div class="form-group">
                                    <label for="produk_kategori">Kategori</label>
                                    <input type="nama" class="form-control" id="produk_kategori" name="produk_kategori">
