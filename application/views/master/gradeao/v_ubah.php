...
<head>
    ...
    <title>SIMONA | Ubah Grade Agent</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Ubah Data Grade Agent</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header">
                            <h2>Ubah Data Grade</h2>
                        </div>

                        <div class="card-body">
                            <form action="" method="post">
                                <div class="form-group">
                                    <input type="hidden" value="<?= $grade['grade_id']; ?>" name="grade_id">
                                    <label for="grade_name">Grade</label>
                                    <input type="nama" value="<?= $grade['grade_name']; ?>" class="form-control" id="grade_name" name="grade_name">
