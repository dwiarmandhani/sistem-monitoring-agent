                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header">
                            <a href="<?php echo base_url('master/masteruseradmin/tambah'); ?>" class="btn btn-success"><small><i class="fa fa-pen"></i></small> Tambah</a>
                        </div>
                        <!-- /.card-header -->
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <div class="d-inline-block pr-2">
                                                                <a href="<?php echo base_url('master/masteruseradmin/ubah/'); ?><?= $value->user_id; ?>" class="btn btn-warning">Edit</a>
                                                            </div>
                                                            <div class="d-inline-block">
                                                                <a href="<?php echo base_url('master/masteruseradmin/hapus/'); ?><?= $value->user_id; ?>" class="btn btn-danger">Delete</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
